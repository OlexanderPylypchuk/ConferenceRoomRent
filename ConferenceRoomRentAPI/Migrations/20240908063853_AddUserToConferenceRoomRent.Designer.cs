...
namespace ConferenceRoomRentAPI.Migrations
{
    ...
    [Migration("20240908063853_AddUserToConferenceRoomRent")]
    partial class AddUserToConferenceRoomRent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConferenceRoomRentAPI.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("ConferenceRoomRentAPI.Models.ConferenceRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConferenceRoomRentAPI.Models.ConferenceRoomRent", b =>
                {
                    b.HasOne("ConferenceRoomRentAPI.Models.ConferenceRoom", "ConferenceRoom")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ConferenceRoomRentAPI.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
